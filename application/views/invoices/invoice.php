				...
				<div class="invoice-wrapper">
					<div class="invoice-info">
						<div class="company-info">
							<img src="<?php echo base_url() . 'assets/images/logo.png'; ?>" style="width: 60px;height: 60px;">
							...
							<tbody>
								<?php foreach ($transaction_details as $transaction_detail) { ?>
									<tr>
										...
										<td class="text-right">Rp. <?php echo number_format($transaction_detail->bills_amount); ?></td>
									</tr>
								<?php } ?>
							</tbody>
							<tfoot>
								<tr>
									<td>Total</td>
									<td class="text-right" colspan="2">Rp. <?php echo number_format($transaction->amount); ?></td>
								</tr>
							</tfoot>
						</table>
					</div>
