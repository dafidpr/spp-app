...
// $this->Image('http://localhost/school_payment/assets/images/logo.png',2,1,3);

$this->setXY(0,1);
$this->SetFont('Arial','B',16);
$this->Cell(0,1,"Laporan Piutang",0,0,'C');
...
$pdf->Output("Laporan_Piutang_".date('Y-m-d').".pdf","I");
?>