...
// $this->Image('http://localhost/demo/assets/images/logo.png',2,1,3);

$this->setXY(0,1);
$this->SetFont('Arial','B',16);
$this->Cell(0,1,"Laporan Tunggakan",0,0,'C');
...
$pdf->Output("Laporan_Tunggakan_".date('Y-m-d').".pdf","I");
?>