				...
				<div class="col-md-12">
					<div class="content-box">
						<div class="content-box-header">
							<div class="row">
								<div class="col-md-6">
									<button class="btn btn-primary" onclick="main_routes('create', '')"><i class="fa fa-pencil"></i> Tambah Kelas</button>
								</div>
...
<script type="text/javascript">
	var datagrid = $("#datagrid").datagrid({
		url						: "<?php echo base_url() . 'students_group/data'; ?>",
		primaryField			: 'id', 
		rowNumber				: true,
		...
		columns					: [
		{field: 'students_group_name', title: 'Nama', editable: true, sortable: false, width: 200, align: 'left', search: true},
		{field: 'schools_group_name', title: 'Sekolah', editable: true, sortable: false, width: 200, align: 'left', search: true},
		{field: 'students_level_name', title: 'Jenjang', editable: true, sortable: false, width: 200, align: 'left', search: true},
		{field: 'teachers_name', title: 'Guru', editable: true, sortable: false, width: 200, align: 'left', search: true},
	...
	function create_update_form(rowIndex) {
		$.post("<?php echo base_url() . 'students_group/form'; ?>", {index : rowIndex}).done(function(data) {
	...
	function delete_action(rowIndex) {
		swal({   
			...
			$.post("<?php echo base_url() . 'students_group/delete'; ?>", {id : row.id}).done(function(data) {
				datagrid.reload()
			})
		})
	}
