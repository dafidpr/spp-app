				...
				<div class="col-md-12">
					<div class="content-box">
						<div class="content-box-header">
							<div class="row">
								<div class="col-md-6">
									<button class="btn btn-primary" onclick="main_routes('create', '')"><i class="fa fa-pencil"></i> Tambah Sekolah</button>
								</div>
...
<script type="text/javascript">
	var datagrid = $("#datagrid").datagrid({
		url						: "<?php echo base_url() . 'schools_group/data'; ?>",
		primaryField			: 'id', 
		rowNumber				: true,
		...
		columns					: [
		{field: 'schools_group_name', title: 'Nama', editable: true, sortable: false, width: 200, align: 'left', search: true},
	...
	function create_update_form(rowIndex) {
		$.post("<?php echo base_url() . 'schools_group/form'; ?>", {index : rowIndex}).done(function(data) {
	...
	function delete_action(rowIndex) {
		swal({   
			...
			$.post("<?php echo base_url() . 'schools_group/delete'; ?>", {id : row.id}).done(function(data) {
				datagrid.reload()
			})
		})
	}
