...
<div class="content">
	<div class="panel">
		<div class="content-header no-mg-top">
			...
			<div class="content-header-title">Transaksi</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="row">
	...
	<script type="text/javascript">	
		function filter(url) {
			if($("#key").val() == ''){
				...
				if(url == null)
					url = "<?=base_url()?>transactions/search_bills";
		...
		$('#key').select2({
			ajax: {
				url: '<?=base_url()?>students/json_mahasiswa',
				dataType: 'json',
				delay: 250,
  ...
  templateSelection: formatMahasiswaSelection // omitted for brevity, see the source of this page
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#students_group_name").html("<p>"+arrBio[3]+" | "+arrBio[4]+" | "+arrBio[5]+"</p>");
			filter();
		}
	});
	return false;
