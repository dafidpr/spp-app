        ...
        <div class="col-md-12">
          <div class="content-box">
            <div class="content-box-header">
              <div class="row">
                <div class="col-md-6">
                  <button class="btn btn-primary" onclick="main_routes('create', '')"><i class="fa fa-pencil"></i> Add New Billings</button>
                </div>
...
<script type="text/javascript">
  ...
  var datagrid = $("#datagrid").datagrid({
    url           : "<?php echo base_url() . 'billing/data/'. $ID; ?>",
    primaryField      : 'id', 
    rowNumber       : true,
    ...
    columns         : [
    {field: 'bills_category_name', title: 'Category', editable: true, sortable: false, width: 200, align: 'left', search: true},
    ...
    {field: 'duedate', title: 'Duedate', editable: true, sortable: false, width: 200, align: 'left', search: true},
    {field: 'note', title: 'Note', editable: true, sortable: false, width: 200, align: 'left', search: true},
  ...
  function create_update_form(rowIndex) {
    $.post("<?php echo base_url() . 'billing/form/'. $ID; ?>", {index : rowIndex}).done(function(data) {
  ...
  function delete_action(rowIndex) {
    swal({   
      ...
      $.post("<?php echo base_url() . 'billing/delete'; ?>", {id : row.id}).done(function(data) {
        datagrid.reload()
      })
    })
  }
