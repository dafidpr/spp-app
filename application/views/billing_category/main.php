	...
	<div class="content">
		<div class="panel">
			<div class="content-header no-mg-top">
				...
				<div class="content-header-title">Billing Category</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="content-box">
						<div class="content-box-header">
							<div class="row">
								<div class="col-md-6">
									<button class="btn btn-primary" onclick="main_routes('create', '')"><i class="fa fa-pencil"></i> Add New Billing Category</button>
								</div>
...
<script type="text/javascript">
	var datagrid = $("#datagrid").datagrid({
		url						: "<?php echo base_url() . 'billing_category/data'; ?>",
		primaryField			: 'id', 
		rowNumber				: true,
		...
		columns					: [
		{field: 'bills_category_name', title: 'Category Name', editable: true, sortable: false, width: 200, align: 'left', search: true},
		{field: 'bills_category_status', title: 'Status', editable: true, sortable: false, width: 300, align: 'left', search: true},
	...
	function create_update_form(rowIndex) {
		$.post("<?php echo base_url() . 'billing_category/form'; ?>", {index : rowIndex}).done(function(data) {
	...
	function delete_action(rowIndex) {
		swal({   
			...
			$.post("<?php echo base_url() . 'billing_category/delete'; ?>", {id : row.id}).done(function(data) {
				datagrid.reload()
			})
		})
	}
