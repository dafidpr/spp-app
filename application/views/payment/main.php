												...
												<tbody>
													...
													<tr>
														...
														<tr>
															...
															<td style="text-align: center;"><p><?=number_format($temporary->amount,0,',','.')?></p><p><?=date('d-m-Y',strtotime($temporary->duedate))?></p></td>
			...
			if(status==true)
			{
				$.ajax({
					...
					success: function(data) {
						$( "#form-checkout" ).load( "<?=base_url()?>payment/load_payment");
					}
				});
			}
			else
